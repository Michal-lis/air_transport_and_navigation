...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_udpReceive_example_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_udpReceive_example_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_udpReceive_example_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "udpReceive_example") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_udpReceive_example_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_udpReceive_example_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "udpReceive_example") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_udpReceive_example_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_udpReceive_example_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"udpReceive_example")) {
    return(sf_udpReceive_example_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void udpReceive_example_terminator(void);
...
extern void udpReceive_example_initializer(void);
extern void udpReceive_example_register_exported_symbols(SimStruct* S);
extern void udpReceive_example_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  udpReceive_example_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      udpReceive_example_debug_initialize();
    }

    udpReceive_example_initializer();
  }
