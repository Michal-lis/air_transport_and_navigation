...
static void initialize_c4_xplane_interface(SFc4_xplane_interfaceInstanceStruct
  *chartInstance);
static void initialize_params_c4_xplane_interface
  (SFc4_xplane_interfaceInstanceStruct *chartInstance);
static void enable_c4_xplane_interface(SFc4_xplane_interfaceInstanceStruct
  *chartInstance);
static void disable_c4_xplane_interface(SFc4_xplane_interfaceInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_xplane_interface
  (SFc4_xplane_interfaceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_xplane_interface
  (SFc4_xplane_interfaceInstanceStruct *chartInstance);
static void set_sim_state_c4_xplane_interface
  (SFc4_xplane_interfaceInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_xplane_interface(SFc4_xplane_interfaceInstanceStruct
  *chartInstance);
static void sf_c4_xplane_interface(SFc4_xplane_interfaceInstanceStruct
  *chartInstance);
static void initSimStructsc4_xplane_interface
  (SFc4_xplane_interfaceInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_send_msg, const char_T *c4_identifier,
  uint8_T c4_y[509]);
static void c4_b_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
...
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real32_T c4_d_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_e_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  uint8_T c4_y[29]);
...
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_f_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  uint8_T c4_y[4]);
...
static const mxArray *c4_g_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_g_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_h_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_xplane_interface, const
  char_T *c4_identifier);
static uint8_T c4_i_emlrt_marshallIn(SFc4_xplane_interfaceInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_xplane_interfaceInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_xplane_interface = 0U;
}
  ...
  (SFc4_xplane_interfaceInstanceStruct *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_xplane_interface;
  ...
  (SFc4_xplane_interfaceInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_xplane_interface = c4_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_xplane_interface");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_xplane_interface(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_xplane_interfaceInstanceStruct *chartInstance;
  chartInstance = (SFc4_xplane_interfaceInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_xplane_interface_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_xplane_interface), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_xplane_interface);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_xplane_interface_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_xplane_interface_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_xplane_interface(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"send_msg\",},{M[8],M[0],T\"is_active_c4_xplane_interface\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_xplane_interface_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_xplane_interfaceInstanceStruct *chartInstance;
    chartInstance = (SFc4_xplane_interfaceInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c4_xplane_interface(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_xplane_interfaceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*)
    chartInstanceVar);
  initialize_c4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_xplane_interface(void *chartInstanceVar)
{
  enable_c4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_xplane_interface(void *chartInstanceVar)
{
  disable_c4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_xplane_interface(void *chartInstanceVar)
{
  sf_c4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_xplane_interface(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_xplane_interface
    ((SFc4_xplane_interfaceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_xplane_interface();/* state var info */
...
extern void sf_internal_set_sim_state_c4_xplane_interface(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_xplane_interface(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_xplane_interface(S);
}

static void sf_opaque_set_sim_state_c4_xplane_interface(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_xplane_interface(S, st);
}

static void sf_opaque_terminate_c4_xplane_interface(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_xplane_interfaceInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_xplane_interface((SFc4_xplane_interfaceInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_xplane_interface(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_xplane_interface(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_xplane_interface(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_xplane_interface(SimStruct *S)
{
  SFc4_xplane_interfaceInstanceStruct *chartInstance;
  chartInstance = (SFc4_xplane_interfaceInstanceStruct *)malloc(sizeof
    (SFc4_xplane_interfaceInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_xplane_interfaceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_xplane_interface;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_xplane_interface;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_xplane_interface;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_xplane_interface;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_xplane_interface;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_xplane_interface;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_xplane_interface;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_xplane_interface;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_xplane_interface;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_xplane_interface;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_xplane_interface;
...
void c4_xplane_interface_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_xplane_interface(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_xplane_interface(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_xplane_interface(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_xplane_interface_method_dispatcher.\n"
