...
#include "control_and_guidance_sfun_debug_macros.h"
...
static void initialize_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void initialize_params_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void enable_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void disable_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void set_sim_state_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void sf_c2_control_and_guidance(SFc2_control_and_guidanceInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void initSimStructsc2_control_and_guidance
  (SFc2_control_and_guidanceInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
  *chartInstance, const mxArray *c2_b_N, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_eml_scalar_eg(SFc2_control_and_guidanceInstanceStruct
  *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_e_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  c2_sqlDPqpC0uriFz1tcs1upYG c2_y[6]);
static char_T c2_f_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_g_emlrt_marshallIn
  (SFc2_control_and_guidanceInstanceStruct *chartInstance, const mxArray *c2_b_h,
   const char_T *c2_identifier);
static const mxArray *c2_h_emlrt_marshallIn
  (SFc2_control_and_guidanceInstanceStruct *chartInstance, const mxArray *c2_u,
   const emlrtMsgIdentifier *c2_parentId);
static uint8_T c2_i_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_control_and_guidance, const
  char_T *c2_identifier);
static uint8_T c2_j_emlrt_marshallIn(SFc2_control_and_guidanceInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_control_and_guidanceInstanceStruct
  *chartInstance);
  ...
  (SFc2_control_and_guidanceInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_control_and_guidance = 0U;
}
  ...
  (SFc2_control_and_guidanceInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_control_and_guidance;
  ...
  (SFc2_control_and_guidanceInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_control_and_guidance = c2_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_control_and_guidance");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_control_and_guidance(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_control_and_guidance(chartInstance);
  sf_debug_check_for_state_inconsistency(_control_and_guidanceMachineNumber_,
  ...
  (SFc2_control_and_guidanceInstanceStruct *chartInstance)
{
  ...
  const mxArray *c2_y = NULL;
  int32_T c2_i4;
  static char_T c2_cv1[5] = { 'e', 'q', 'u', 'a', 'l' };
  ...
  if (CV_EML_IF(0, 1, 0, !chartInstance->c2_h_not_empty)) {
    ...
    sf_mex_assign(&c2_b_y, sf_mex_create("y", c2_b_u, 10, 0U, 1U, 0U, 2, 1, 5),
                  FALSE);
    sf_mex_call_debug("axis", 0U, 2U, 14, sf_mex_dup(chartInstance->c2_h), 14,
                      c2_b_y);
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 18);
    c2_c_u = -0.34334796409554608;
    c2_c_y = NULL;
    sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_c_u, 0, 0U, 0U, 0U, 0), FALSE);
    c2_d_u = 39.47617517913698;
    c2_d_y = NULL;
    ...
    sf_mex_assign(&c2_e_y, sf_mex_create("y", c2_e_u, 10, 0U, 1U, 0U, 2, 1, 2),
                  FALSE);
    sf_mex_call_debug("plot", 0U, 3U, 14, c2_c_y, 14, c2_d_y, 14, c2_e_y);
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 19);
    for (c2_i6 = 0; c2_i6 < 2; c2_i6++) {
      c2_f_u[c2_i6] = c2_cv3[c2_i6];
    }

    c2_f_y = NULL;
    sf_mex_assign(&c2_f_y, sf_mex_create("y", c2_f_u, 10, 0U, 1U, 0U, 2, 1, 2),
                  FALSE);
    sf_mex_call_debug("hold", 0U, 1U, 14, c2_f_y);
    c2_i = 0;
    while (c2_i < 5) {
      ...
      sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_g_u, 0, 0U, 0U, 0U, 0),
                    FALSE);
      c2_h_u = c2_rv1[_SFD_EML_ARRAY_BOUNDS_CHECK("wp", (int32_T)
      ...
      for (c2_i7 = 0; c2_i7 < 2; c2_i7++) {
        c2_i_u[c2_i7] = c2_cv4[c2_i7];
      }

      c2_i_y = NULL;
      sf_mex_assign(&c2_i_y, sf_mex_create("y", c2_i_u, 10, 0U, 1U, 0U, 2, 1, 2),
                    FALSE);
      sf_mex_call_debug("plot", 0U, 3U, 14, c2_g_y, 14, c2_h_y, 14, c2_i_y);
      c2_i++;
      sf_mex_listen_for_ctrl_c(chartInstance->S);
    }
    ...
    c2_c_i = 0;
    while (c2_c_i < 5) {
      c2_b_i = 2.0 + (real_T)c2_c_i;
      CV_EML_FOR(0, 1, 1, 1);
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 24);
      c2_j_u[0] = c2_rv1[_SFD_EML_ARRAY_BOUNDS_CHECK("wp", (int32_T)
        _SFD_INTEGER_CHECK("i-1", c2_b_i - 1.0), 1, 6, 1, 0) - 1]._long;
      c2_j_u[1] = c2_rv1[_SFD_EML_ARRAY_BOUNDS_CHECK("wp", (int32_T)
        _SFD_INTEGER_CHECK("i", c2_b_i), 1, 6, 1, 0) - 1]._long;
      c2_j_y = NULL;
      sf_mex_assign(&c2_j_y, sf_mex_create("y", c2_j_u, 0, 0U, 1U, 0U, 2, 1, 2),
                    FALSE);
      c2_k_u[0] = c2_rv1[_SFD_EML_ARRAY_BOUNDS_CHECK("wp", (int32_T)
        _SFD_INTEGER_CHECK("i-1", c2_b_i - 1.0), 1, 6, 1, 0) - 1].lat;
      c2_k_u[1] = c2_rv1[_SFD_EML_ARRAY_BOUNDS_CHECK("wp", (int32_T)
        _SFD_INTEGER_CHECK("i", c2_b_i), 1, 6, 1, 0) - 1].lat;
      c2_k_y = NULL;
      sf_mex_assign(&c2_k_y, sf_mex_create("y", c2_k_u, 0, 0U, 1U, 0U, 2, 1, 2),
                    FALSE);
      sf_mex_call_debug("plot", 0U, 2U, 14, c2_j_y, 14, c2_k_y);
      c2_c_i++;
      sf_mex_listen_for_ctrl_c(chartInstance->S);
    }
  ...
  if (CV_EML_IF(0, 1, 1, c2_r == 0.0)) {
    ...
    for (c2_i8 = 0; c2_i8 < 2; c2_i8++) {
      c2_n_u[c2_i8] = c2_cv5[c2_i8];
    }

    c2_n_y = NULL;
    sf_mex_assign(&c2_n_y, sf_mex_create("y", c2_n_u, 10, 0U, 1U, 0U, 2, 1, 2),
                  FALSE);
    sf_mex_call_debug("plot", 0U, 4U, 14, sf_mex_dup(chartInstance->c2_h), 14,
                      c2_l_y, 14, c2_m_y, 14, c2_n_y);
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_control_and_guidanceInstanceStruct *chartInstance;
  chartInstance = (SFc2_control_and_guidanceInstanceStruct *)chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  for (c2_i9 = 0; c2_i9 < 6; c2_i9++) {
    c2_b_inData[c2_i9] = (*(c2_sqlDPqpC0uriFz1tcs1upYG (*)[6])c2_inData)[c2_i9];
  }
  ...
  for (c2_i12 = 0; c2_i12 < 6; c2_i12++) {
    ...
    sf_mex_addfield(c2_y, c2_b_y, "name", "name", c2_i12);
    c2_c_u = c2_r1->_long;
    c2_c_y = NULL;
    sf_mex_assign(&c2_c_y, sf_mex_create("y", &c2_c_u, 0, 0U, 0U, 0U, 0), FALSE);
    sf_mex_addfield(c2_y, c2_c_y, "long", "long", c2_i12);
    c2_d_u = c2_r1->lat;
    c2_d_y = NULL;
    sf_mex_assign(&c2_d_y, sf_mex_create("y", &c2_d_u, 0, 0U, 0U, 0U, 0), FALSE);
    sf_mex_addfield(c2_y, c2_d_y, "lat", "lat", c2_i12);
    c2_e_u = c2_r1->alt;
    c2_e_y = NULL;
    sf_mex_assign(&c2_e_y, sf_mex_create("y", &c2_e_u, 0, 0U, 0U, 0U, 0), FALSE);
    sf_mex_addfield(c2_y, c2_e_y, "alt", "alt", c2_i12);
    c2_f_u = c2_r1->airspeed;
    c2_f_y = NULL;
    sf_mex_assign(&c2_f_y, sf_mex_create("y", &c2_f_u, 0, 0U, 0U, 0U, 0), FALSE);
    sf_mex_addfield(c2_y, c2_f_y, "airspeed", "airspeed", c2_i12);
    c2_g_u = c2_r1->fase;
    c2_g_y = NULL;
    sf_mex_assign(&c2_g_y, sf_mex_create("y", &c2_g_u, 0, 0U, 0U, 0U, 0), FALSE);
    sf_mex_addfield(c2_y, c2_g_y, "fase", "fase", c2_i12);
  }
...
const mxArray *sf_c2_control_and_guidance_get_eml_resolved_functions_info(void)
{
  ...
  for (c2_i13 = 0; c2_i13 < 13; c2_i13++) {
    ...
    sf_mex_addfield(c2_m1, sf_mex_create("nameCaptureInfo", c2_r2->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c2_r2->name)), "name", "nameCaptureInfo", c2_i13);
  ...
  c2_sqlDPqpC0uriFz1tcs1upYG c2_y[6])
{
  ...
  for (c2_i15 = 0; c2_i15 < 2; c2_i15++) {
    c2_uv0[c2_i15] = 1U + 5U * (uint32_T)c2_i15;
  }
  ...
  for (c2_i16 = 0; c2_i16 < 6; c2_i16++) {
    ...
    (*c2_r3)[c2_i16].name = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c2_u, "name", "name", c2_i16)), &c2_thisId);
    c2_thisId.fIdentifier = "long";
    (*c2_r3)[c2_i16]._long = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c2_u, "long", "long", c2_i16)), &c2_thisId);
    c2_thisId.fIdentifier = "lat";
    (*c2_r3)[c2_i16].lat = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c2_u, "lat", "lat", c2_i16)), &c2_thisId);
    c2_thisId.fIdentifier = "alt";
    (*c2_r3)[c2_i16].alt = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c2_u, "alt", "alt", c2_i16)), &c2_thisId);
    c2_thisId.fIdentifier = "airspeed";
    (*c2_r3)[c2_i16].airspeed = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c2_u, "airspeed", "airspeed", c2_i16)), &c2_thisId);
    c2_thisId.fIdentifier = "fase";
    (*c2_r3)[c2_i16].fase = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c2_u, "fase", "fase", c2_i16)), &c2_thisId);
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i17 = 0; c2_i17 < 6; c2_i17++) {
    (*(c2_sqlDPqpC0uriFz1tcs1upYG (*)[6])c2_outData)[c2_i17] = c2_y[c2_i17];
  }
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_control_and_guidance), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_control_and_guidance);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_control_and_guidance_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3301285070U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4170862253U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2376747163U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(577435850U);
}

mxArray *sf_c2_control_and_guidance_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("41BiGFyRXdF0uwKjsiwExG");
...
static const mxArray *sf_get_sim_state_info_c2_control_and_guidance(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[4],M[0],T\"N\",S'l','i','p'{{M1x2[187 188],M[0],}}},{M[4],M[0],T\"h\",S'l','i','p'{{M1x2[185 186],M[0],}}},{M[8],M[0],T\"is_active_c2_control_and_guidance\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_control_and_guidance_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_control_and_guidanceInstanceStruct *chartInstance;
    chartInstance = (SFc2_control_and_guidanceInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_control_and_guidanceMachineNumber_,
           2,
           1,
           1,
           4,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_control_and_guidanceMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_control_and_guidanceMachineNumber_,chartInstance->chartNumber,1);
        ...
        _SFD_CV_INIT_EML(0,1,1,2,0,0,2,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,582);
        _SFD_CV_INIT_EML_IF(0,1,0,190,203,-1,507);
        _SFD_CV_INIT_EML_IF(0,1,1,532,550,-1,582);
        _SFD_CV_INIT_EML_FOR(0,1,0,328,343,395);
        _SFD_CV_INIT_EML_FOR(0,1,1,400,415,487);
      ...
      sf_debug_reset_current_state_configuration
        (_control_and_guidanceMachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}
...
{
  return "jluRzoDqNUxjHdU5nP0vKF";
}

static void sf_opaque_initialize_c2_control_and_guidance(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_control_and_guidanceInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_control_and_guidance
    ((SFc2_control_and_guidanceInstanceStruct*) chartInstanceVar);
  initialize_c2_control_and_guidance((SFc2_control_and_guidanceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_control_and_guidance(void *chartInstanceVar)
{
  enable_c2_control_and_guidance((SFc2_control_and_guidanceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_control_and_guidance(void *chartInstanceVar)
{
  disable_c2_control_and_guidance((SFc2_control_and_guidanceInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_control_and_guidance(void *chartInstanceVar)
{
  sf_c2_control_and_guidance((SFc2_control_and_guidanceInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_control_and_guidance
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_control_and_guidance
    ((SFc2_control_and_guidanceInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_control_and_guidance();/* state var info */
...
extern void sf_internal_set_sim_state_c2_control_and_guidance(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_control_and_guidance((SFc2_control_and_guidanceInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_control_and_guidance(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_control_and_guidance(S);
}

static void sf_opaque_set_sim_state_c2_control_and_guidance(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_control_and_guidance(S, st);
}

static void sf_opaque_terminate_c2_control_and_guidance(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_control_and_guidanceInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_control_and_guidance((SFc2_control_and_guidanceInstanceStruct*)
      chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_control_and_guidance_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc2_control_and_guidance((SFc2_control_and_guidanceInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_control_and_guidance(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_control_and_guidance
      ((SFc2_control_and_guidanceInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_control_and_guidance(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_control_and_guidance_optimization_info();
  ...
  ssSetChecksum0(S,(3178689885U));
  ssSetChecksum1(S,(2577233296U));
  ssSetChecksum2(S,(626511018U));
  ssSetChecksum3(S,(3330958568U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_control_and_guidance(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_control_and_guidance(SimStruct *S)
{
  SFc2_control_and_guidanceInstanceStruct *chartInstance;
  chartInstance = (SFc2_control_and_guidanceInstanceStruct *)malloc(sizeof
    (SFc2_control_and_guidanceInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_control_and_guidanceInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_control_and_guidance;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_control_and_guidance;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_control_and_guidance;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_control_and_guidance;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_control_and_guidance;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_control_and_guidance;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_control_and_guidance;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_control_and_guidance;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_control_and_guidance;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_control_and_guidance;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_control_and_guidance;
...
void c2_control_and_guidance_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_control_and_guidance(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_control_and_guidance(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_control_and_guidance(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_control_and_guidance_method_dispatcher.\n"
