#ifndef __c2_control_and_guidance_h__
#define __c2_control_and_guidance_h__
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_control_and_guidance;
...
extern const mxArray *sf_c2_control_and_guidance_get_eml_resolved_functions_info
  (void);

/* Function Definitions */
extern void sf_c2_control_and_guidance_get_check_sum(mxArray *plhs[]);
extern void c2_control_and_guidance_method_dispatcher(SimStruct *S, int_T method,
  void *data);
