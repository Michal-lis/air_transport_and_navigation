#ifndef __c2_xplane_interface2_h__
#define __c2_xplane_interface2_h__
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_xplane_interface2;
  SimStruct *S;
...
extern const mxArray *sf_c2_xplane_interface2_get_eml_resolved_functions_info
  (void);

/* Function Definitions */
extern void sf_c2_xplane_interface2_get_check_sum(mxArray *plhs[]);
extern void c2_xplane_interface2_method_dispatcher(SimStruct *S, int_T method,
  void *data);
