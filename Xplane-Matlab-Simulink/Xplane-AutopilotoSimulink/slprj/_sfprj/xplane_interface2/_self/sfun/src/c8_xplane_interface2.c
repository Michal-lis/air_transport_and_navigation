...
static void initialize_c8_xplane_interface2(SFc8_xplane_interface2InstanceStruct
  *chartInstance);
static void initialize_params_c8_xplane_interface2
  (SFc8_xplane_interface2InstanceStruct *chartInstance);
static void enable_c8_xplane_interface2(SFc8_xplane_interface2InstanceStruct
  *chartInstance);
static void disable_c8_xplane_interface2(SFc8_xplane_interface2InstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_xplane_interface2
  (SFc8_xplane_interface2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_xplane_interface2
  (SFc8_xplane_interface2InstanceStruct *chartInstance);
static void set_sim_state_c8_xplane_interface2
  (SFc8_xplane_interface2InstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_xplane_interface2(SFc8_xplane_interface2InstanceStruct
  *chartInstance);
static void sf_c8_xplane_interface2(SFc8_xplane_interface2InstanceStruct
  *chartInstance);
static void initSimStructsc8_xplane_interface2
  (SFc8_xplane_interface2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_send_msg, const char_T *c8_identifier,
  uint8_T c8_y[509]);
static void c8_b_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
...
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real32_T c8_d_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_e_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  uint8_T c8_y[33]);
...
static const mxArray *c8_e_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_f_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  uint8_T c8_y[4]);
...
static const mxArray *c8_g_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_g_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_h_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_xplane_interface2, const
  char_T *c8_identifier);
static uint8_T c8_i_emlrt_marshallIn(SFc8_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_xplane_interface2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_xplane_interface2 = 0U;
}
  ...
  (SFc8_xplane_interface2InstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_xplane_interface2;
  ...
  (SFc8_xplane_interface2InstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_xplane_interface2 = c8_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 1)),
     "is_active_c8_xplane_interface2");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_xplane_interface2(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_xplane_interface2InstanceStruct *chartInstance;
  chartInstance = (SFc8_xplane_interface2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_xplane_interface2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_xplane_interface2), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_xplane_interface2);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_xplane_interface2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_xplane_interface2_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_xplane_interface2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"send_msg\",},{M[8],M[0],T\"is_active_c8_xplane_interface2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_xplane_interface2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_xplane_interface2InstanceStruct *chartInstance;
    chartInstance = (SFc8_xplane_interface2InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c8_xplane_interface2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_xplane_interface2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
    chartInstanceVar);
  initialize_c8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_xplane_interface2(void *chartInstanceVar)
{
  enable_c8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_xplane_interface2(void *chartInstanceVar)
{
  disable_c8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_xplane_interface2(void *chartInstanceVar)
{
  sf_c8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_xplane_interface2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_xplane_interface2
    ((SFc8_xplane_interface2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_xplane_interface2();/* state var info */
...
extern void sf_internal_set_sim_state_c8_xplane_interface2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_xplane_interface2(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_xplane_interface2(S);
}

static void sf_opaque_set_sim_state_c8_xplane_interface2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_xplane_interface2(S, st);
}

static void sf_opaque_terminate_c8_xplane_interface2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_xplane_interface2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_xplane_interface2((SFc8_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_xplane_interface2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_xplane_interface2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_xplane_interface2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_xplane_interface2(SimStruct *S)
{
  SFc8_xplane_interface2InstanceStruct *chartInstance;
  chartInstance = (SFc8_xplane_interface2InstanceStruct *)malloc(sizeof
    (SFc8_xplane_interface2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_xplane_interface2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_xplane_interface2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_xplane_interface2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_xplane_interface2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_xplane_interface2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_xplane_interface2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_xplane_interface2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_xplane_interface2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_xplane_interface2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_xplane_interface2;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_xplane_interface2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_xplane_interface2;
...
void c8_xplane_interface2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_xplane_interface2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_xplane_interface2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_xplane_interface2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_xplane_interface2_method_dispatcher.\n"
