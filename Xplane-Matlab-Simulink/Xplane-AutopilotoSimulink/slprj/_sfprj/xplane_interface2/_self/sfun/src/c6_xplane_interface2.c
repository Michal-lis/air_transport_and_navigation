...
static void initialize_c6_xplane_interface2(SFc6_xplane_interface2InstanceStruct
  *chartInstance);
static void initialize_params_c6_xplane_interface2
  (SFc6_xplane_interface2InstanceStruct *chartInstance);
static void enable_c6_xplane_interface2(SFc6_xplane_interface2InstanceStruct
  *chartInstance);
static void disable_c6_xplane_interface2(SFc6_xplane_interface2InstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_xplane_interface2
  (SFc6_xplane_interface2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_xplane_interface2
  (SFc6_xplane_interface2InstanceStruct *chartInstance);
static void set_sim_state_c6_xplane_interface2
  (SFc6_xplane_interface2InstanceStruct *chartInstance, const mxArray *c6_st);
static void finalize_c6_xplane_interface2(SFc6_xplane_interface2InstanceStruct
  *chartInstance);
static void sf_c6_xplane_interface2(SFc6_xplane_interface2InstanceStruct
  *chartInstance);
static void initSimStructsc6_xplane_interface2
  (SFc6_xplane_interface2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_send_msg, const char_T *c6_identifier,
  uint8_T c6_y[509]);
static void c6_b_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
...
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real32_T c6_d_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_e_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  uint8_T c6_y[31]);
...
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_f_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  uint8_T c6_y[4]);
...
static const mxArray *c6_g_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_g_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_h_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_xplane_interface2, const
  char_T *c6_identifier);
static uint8_T c6_i_emlrt_marshallIn(SFc6_xplane_interface2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_xplane_interface2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_xplane_interface2 = 0U;
}
  ...
  (SFc6_xplane_interface2InstanceStruct *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_xplane_interface2;
  ...
  (SFc6_xplane_interface2InstanceStruct *chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_xplane_interface2 = c6_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_xplane_interface2");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_xplane_interface2(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_xplane_interface2InstanceStruct *chartInstance;
  chartInstance = (SFc6_xplane_interface2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_xplane_interface2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c6_identifier)
{
  ...
  c6_y = c6_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_xplane_interface2), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_xplane_interface2);
  return c6_y;
}
...
/* SFunction Glue Code */
void sf_c6_xplane_interface2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_xplane_interface2_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_xplane_interface2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"send_msg\",},{M[8],M[0],T\"is_active_c6_xplane_interface2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_xplane_interface2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_xplane_interface2InstanceStruct *chartInstance;
    chartInstance = (SFc6_xplane_interface2InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c6_xplane_interface2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_xplane_interface2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
    chartInstanceVar);
  initialize_c6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_xplane_interface2(void *chartInstanceVar)
{
  enable_c6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_xplane_interface2(void *chartInstanceVar)
{
  disable_c6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_xplane_interface2(void *chartInstanceVar)
{
  sf_c6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_xplane_interface2(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_xplane_interface2
    ((SFc6_xplane_interface2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_xplane_interface2();/* state var info */
...
extern void sf_internal_set_sim_state_c6_xplane_interface2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_xplane_interface2(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_xplane_interface2(S);
}

static void sf_opaque_set_sim_state_c6_xplane_interface2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_xplane_interface2(S, st);
}

static void sf_opaque_terminate_c6_xplane_interface2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_xplane_interface2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_xplane_interface2((SFc6_xplane_interface2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_xplane_interface2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_xplane_interface2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_xplane_interface2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_xplane_interface2(SimStruct *S)
{
  SFc6_xplane_interface2InstanceStruct *chartInstance;
  chartInstance = (SFc6_xplane_interface2InstanceStruct *)malloc(sizeof
    (SFc6_xplane_interface2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_xplane_interface2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_xplane_interface2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_xplane_interface2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_xplane_interface2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_xplane_interface2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_xplane_interface2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_xplane_interface2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_xplane_interface2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_xplane_interface2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_xplane_interface2;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_xplane_interface2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_xplane_interface2;
...
void c6_xplane_interface2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_xplane_interface2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_xplane_interface2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_xplane_interface2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_xplane_interface2_method_dispatcher.\n"
