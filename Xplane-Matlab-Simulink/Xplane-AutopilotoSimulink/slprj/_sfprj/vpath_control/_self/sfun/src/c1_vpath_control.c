...
#include "vpath_control_sfun_debug_macros.h"
...
static void initialize_c1_vpath_control(SFc1_vpath_controlInstanceStruct
  *chartInstance);
static void initialize_params_c1_vpath_control(SFc1_vpath_controlInstanceStruct *
  chartInstance);
static void enable_c1_vpath_control(SFc1_vpath_controlInstanceStruct
  *chartInstance);
static void disable_c1_vpath_control(SFc1_vpath_controlInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_vpath_control
  (SFc1_vpath_controlInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_vpath_control
  (SFc1_vpath_controlInstanceStruct *chartInstance);
static void set_sim_state_c1_vpath_control(SFc1_vpath_controlInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_vpath_control(SFc1_vpath_controlInstanceStruct
  *chartInstance);
static void sf_c1_vpath_control(SFc1_vpath_controlInstanceStruct *chartInstance);
static void initSimStructsc1_vpath_control(SFc1_vpath_controlInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_vpath_controlInstanceStruct
  *chartInstance, const mxArray *c1_elevators_ratio, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_vpath_controlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_eml_scalar_eg(SFc1_vpath_controlInstanceStruct *chartInstance);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_vpath_controlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_vpath_controlInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_vpath_control, const char_T
  *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_vpath_controlInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_vpath_controlInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_vpath_control = 0U;
}
  ...
  (SFc1_vpath_controlInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_vpath_control;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_elevators_ratio = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_vpath_control = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_vpath_control");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_vpath_control(chartInstance);
...
static void sf_c1_vpath_control(SFc1_vpath_controlInstanceStruct *chartInstance)
{
  ...
  *c1_b_elevators_ratio = c1_elevators_ratio;
  ...
  sf_debug_check_for_state_inconsistency(_vpath_controlMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_vpath_controlInstanceStruct *chartInstance;
  chartInstance = (SFc1_vpath_controlInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_vpath_control_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_vpath_control), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_vpath_control);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_vpath_control_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_vpath_control_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_vpath_control(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"elevators_ratio\",},{M[8],M[0],T\"is_active_c1_vpath_control\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_vpath_control_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_vpath_controlInstanceStruct *chartInstance;
    chartInstance = (SFc1_vpath_controlInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_vpath_controlMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_vpath_controlMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_vpath_controlMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_vpath_controlMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_vpath_control(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_vpath_controlInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_vpath_control((SFc1_vpath_controlInstanceStruct*)
    chartInstanceVar);
  initialize_c1_vpath_control((SFc1_vpath_controlInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_vpath_control(void *chartInstanceVar)
{
  enable_c1_vpath_control((SFc1_vpath_controlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_vpath_control(void *chartInstanceVar)
{
  disable_c1_vpath_control((SFc1_vpath_controlInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_vpath_control(void *chartInstanceVar)
{
  sf_c1_vpath_control((SFc1_vpath_controlInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_vpath_control(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_vpath_control
    ((SFc1_vpath_controlInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_vpath_control();/* state var info */
...
extern void sf_internal_set_sim_state_c1_vpath_control(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_vpath_control((SFc1_vpath_controlInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_vpath_control(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_vpath_control(S);
}

static void sf_opaque_set_sim_state_c1_vpath_control(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_vpath_control(S, st);
}

static void sf_opaque_terminate_c1_vpath_control(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_vpath_controlInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_vpath_control((SFc1_vpath_controlInstanceStruct*)
      chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_vpath_control_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc1_vpath_control((SFc1_vpath_controlInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_vpath_control(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_vpath_control(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_vpath_control_optimization_info();
...
static void mdlRTW_c1_vpath_control(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_vpath_control(SimStruct *S)
{
  SFc1_vpath_controlInstanceStruct *chartInstance;
  chartInstance = (SFc1_vpath_controlInstanceStruct *)malloc(sizeof
    (SFc1_vpath_controlInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_vpath_controlInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_vpath_control;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_vpath_control;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_vpath_control;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_vpath_control;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_vpath_control;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_vpath_control;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_vpath_control;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_vpath_control;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_vpath_control;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_vpath_control;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_vpath_control;
...
void c1_vpath_control_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_vpath_control(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_vpath_control(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_vpath_control(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_vpath_control_method_dispatcher.\n"
